class WishlistsController < ApplicationController
  ...
  def create
    ...
    p "Wishlist>>>>>>>>>>#{@wishlist.inspect}"
    respond_to do |format|
      if @wishlist.save
        format.html { redirect_to request.referrer, notice: "Wishlist was successfully created." }
        format.json { render :show, status: :created, location: @wishlist }
      else
        format.html { redirect_to request.referrer, alert: :unprocessable_entity }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to request.referrer, notice: "Wishlist was successfully destroyed." }
